            ...
            <footer className="main-footer">
              <div className="container footer-container">
                ...
                <div className="footer-socials">
                  ...
                  <a href="https://telegram.org" target="_blank" rel="noreferrer" className="social-icon-btn" aria-label="Telegram">
                    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.121l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.195 1.006.128.832.941z"/></svg>
                  </a>
